...
const DEFAULT_CHARACTER_POLICY_STUPIDITY_RULE = '严禁为了强行反转让人物突然降智、突然看不见明牌风险。'
const DEFAULT_CHARACTER_POLICY_MUTATION_RULE = '严禁人物无铺垫性格突变；真要变招，必须先有欲望、恐惧或压强升级。'
...
export function normalizeShortDramaConstitution(
  ...
  return {
    ...
    episodeTotal: typeof constitution.episodeTotal === 'number' ? constitution.episodeTotal : undefined,
    incitingIncident: {
    ...
    climaxPolicy: {
      ...
      finalePayoffRule: cleanText(
        constitution.climaxPolicy?.finalePayoffRule,
        DEFAULT_FINALE_RULE
      ),
