...
export async function summarizeChatForGeneration(input: {
  ...
  const prompt = [
    ...
    '4. 如果用户说了很多人物、阵营、组织、地点或跑龙套群像，就尽量整理进世界观、角色卡、人物分层和关系梳理。',
    ...
    '10. 数组控制：keyCharacters 最多 12 个，characterCards 最多 12 个，characterLayers 最多 12 个，themeAnchors/worldAnchors/relationAnchors/softUnderstanding/pendingConfirmations 最多 8 个。',
    ...
    '17. worldAndBackground 必须写明故事发生的世界、时代/行业/规则背景，不能只写题材词。',
    '18. worldAnchors/relationAnchors 必须包含主要阵营、组织、地点或场域，例如朝廷、宗门、公司、学校、医院、村镇、家族、敌对势力。',
    '19. 30集以上必须在 characterLayers 放入功能角色或群像位，例如弟子甲、侍卫乙、村民、小孩、下属、大臣、同事、路人等；这些人不需要完整小传，但后续剧本需要可调度。',
    '20. 如果用户聊天中没提到某一项，你可以基于题材和男频/女频规则给出推荐方案，但必须写具体，不能空。',
    '21. 如果用户明确授权 AI 取名、说自己不会取名、说名字随便取，你必须直接补齐一版可用角色名册，不要把“姓名待用户确认”当作缺失项。',
