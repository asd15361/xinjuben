...
export function createScriptGenerationPrompt(
  ...
  return [
    ...
    '先按这个顺序写，不要一上来平均交代信息：',
    '1. 先把这场最值钱、最会卖的那一刀打出来：谁在压谁、谁在护谁、谁在嘴硬、谁在难堪，并且让最强反差尽快露出来。',
    '2. 再把这种关系压强变成可拍动作，不要只让人物把情况说出来。',
    '2.5. 开场十几秒内就要把“设定成交句”和“核心错位”落成观众一眼能懂的动作、处境或关系反常，不能只停在背景说明里。',
    ...
    '8.5. 再追两件事：这一场到底给出了什么“下一场必须继续看”的理由，这一场最先兑现了哪一口情绪；如果都答不上来，继续改。',
    '8.6. 如果这场读完更像在解释剧情，而不是在卖这一场，那就说明写偏了，继续改到读者会想立刻往下看。',
    ...
    '2. Dialogue:',
    '3. Emotion:',
    '要求：动作具体、对白有钉子句、情绪有推进；如果当前有关系施压快照，必须先把它写成动作、态度和难堪后果，不能只写成情况说明。开场尽快把最强反差和核心错位打到观众眼前，不要把最好卖的那一刀拖后。对白里至少要有一句单拎出来也像人话里的狠句、痛句或护人句。对白一旦谁说都行，就重写到能听出人物自己的位置和口气。只要站位还停在空态度，没有护谁、顶谁、怕失去什么这些关系选择和代价，就继续重写。只要情绪还停在空词，或者只是把情绪直接说破、却没有落到嘴硬、停顿、失手、让步、反咬、压着不退这些反应和代价里，也继续重写。只要这一场没有更强的下一集理由，没有更快兑现情绪，没有把反差写活，就继续重写。只要局势没有更重、关系没有改位、代价没有变实，就继续重写。只要场尾没有自然留下后续能接的动作、关系压力或新危险，也继续重写。',
