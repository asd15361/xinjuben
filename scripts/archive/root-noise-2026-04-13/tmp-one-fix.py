...
# FAILING: '耳边回响' not in prompt -> remove
...
# =====================================================================
# Fix 3: test "adds anti-bloat rules" (line 888)
# NEGATE positive assertions for rules NOT in the prompt
